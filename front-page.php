...
<?php get_header();?>
    ...
    <!-- Carousel -->
    <div id="tastyCarousel" class="carousel slide carousel-fade botMarg" data-ride="carousel" data-pause="false">
        <div class="carousel-inner">
            <div class="carousel-item active frontSlide" data-interval="3500" style="background-image: url('<?php 
            ...
            <div class="carousel-item frontSlide" data-interval="3500" style="background-image: linear-gradient(rgba(0,0,0,0.25),rgba(0,0,0,0)), url('<?php 
            ...
            <div class="carousel-item frontSlide" data-interval="3500" style="background-image: url('<?php 
    ...
    <div class="container">
        <div class="row sidePad">
            <div class="mb-4 mt-4 mx-auto largeLink" style="text-align: center;">  
                <h2 style="font-size: 1.30rem;"><b><?php the_field('tagline');?></b></h2>
            </div>
        </div>
    </div>
    <!-- Full color block -->
        ...
        <div class="container">
            <div class="row">
			    <div class="col" style="text-align: center;">
                    ...
                    <form action="https://belcourpreserves.us6.list-manage.com/subscribe/post?u=981e7aeb45b7827986acd146c&amp;id=09d2c89700" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate rel="noopener">
			            ...
			            <div class="row">
				            <div class="col-6 noPad">
					            <div class="mx-auto" style="width: 30px;">
						            <a href="https://www.instagram.com/belcourpreserves/" target="_blank" rel="noopener">
				            ...
				            <div class="col-6 noPad">
					            <div class="mx-auto" style="width: 30px;">
						            <a href="https://www.facebook.com/BelcourPreserves" target="_blank" rel="noopener">
